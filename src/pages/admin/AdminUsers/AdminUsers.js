...
const AdminUsers = () => {
    ...
    return (
        <div className={!isAdmin ? "admin-pages" : ""}>
            ...
            <Button onClick={handleNewUser} className="add-user">Add User</Button>
                ...
                <Modal.Body className="user-modal">
                    <form onSubmit={handleSubmit} className="user-form">
                        <div className="form-group">
                            ...
                            <input type="text" name="name" id="name" className="form-control" value={newUser.name}
                                   onChange={handleChange}/>
                        </div>
                        <div className="form-group">
                            <label htmlFor="email">Email</label>
                            <input type="email" name="email" id="email" className="form-control" value={newUser.email}
                                   onChange={handleChange}/>
                        </div>
                        <div className="form-group">
                            <label htmlFor="role">Role</label>
                            <select name="role" id="role" className="form-control" value={newUser.role}
                                    onChange={handleChange}>
